...
<html lang="en">
    ...
    <head>
        ...
        <!-- pop up box -->
        <link href="css/finance/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
        <!-- font-awesome icons -->
        <link href="css/finance/fontawesome-all.min.css" rel="stylesheet">
        <!-- //Custom Theme files -->
        <!-- online fonts -->
        <!-- titles -->
                        ...
                        <div class="stats1">
                            <div class="row stats_inner">
                                <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                                    <img src="images/finance/logo1.jpg" alt="logo1" class=" img-fluid">
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                                    <img src="images/finance/logo2.jpg" alt="logo1" class=" img-fluid">
                                </div>
                            </div>
                            <div class="row stats_inner top-st">
                                <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                                    <img src="images/finance/logo3.jpg" alt="logo1" class=" img-fluid">
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
                                    <img src="images/finance/logo1.jpg" alt="logo1" class=" img-fluid">
                                </div>
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div class="row thumbnail adjust1">
                                                    <div class="col-md-3 col-sm-3">
                                                        <img class="media-object img-fluid" src="images/finance/ts1.jpg" alt="" />
                                                    </div>
                                            ...
                                            <div class="carousel-item">
                                                <div class="row thumbnail adjust1">
                                                    <div class="col-md-3 col-sm-3">
                                                        <img class="media-object img-fluid" src="images/finance/ts2.jpg" alt="" />
                                                    </div>
                                                    <div class="col-md-9 col-sm-9">
                                                        <div class="caption testi-text">
                                                            <h4>Jane Wilson</h4>
                                            ...
                                            <div class="carousel-item">
                                                <div class="row thumbnail adjust1">
                                                    <div class="col-md-3 col-sm-3">
                                                        <img class="media-object img-fluid" src="images/finance/ts3.jpg" alt="" />
                                                    </div>
                                                    <div class="col-md-9 col-sm-9">
                                                        <div class="caption testi-text">
                                                            <h4>Jane Wilson</h4>
        ...
        <section class="wthree-row w3-about py-5">
            <div class="container py-md-4 mt-md-3">
                ...
                <div class="card-deck mt-md-5 pt-5">
                    <div class="card">
                        <img src="images/finance/g7.jpg" class="img-fluid" alt="Card image cap">
                    ...
                    <div class="card">
                        <img src="images/finance/g6.jpg" class="img-fluid" alt="Card image cap">
                        <div class="card-body w3ls-card">
                    ...
                    <div class="card">
                        <img src="images/finance/g8.jpg" class="img-fluid" alt="Card image cap">
                        <div class="card-body w3ls-card">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="agileits-w3layouts-info">
                            <img src="images/finance/g6.jpg" class="img-fluid" alt="" />
